<template>
  <main class="min-h-screen bg-black text-white">
    <section
      class="relative h-[500px] flex items-center justify-center overflow-hidden border-b border-zinc-800"
    >
      <div
        class="absolute inset-0 bg-gradient-to-t from-black via-transparent to-emerald-950/20 z-0"
      ></div>
      <div
        class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-emerald-500/10 blur-[120px] rounded-full"
      ></div>
      ...
      <div class="relative z-10 text-center px-6">
        ...
        <div class="flex justify-center">
          <Button
            ...
            class="p-4 bg-emerald-600 border-none font-bold"
    ...
    <section id="products-section" class="max-w-7xl mx-auto px-6 py-20">
      <div class="flex items-end justify-between mb-12">
        ...
        <RouterLink
          v-if="!searchQuery"
          to="/products"
          class="text-zinc-500 hover:text-emerald-500 text-sm font-bold transition-colors"
        >
      ...
      >
        ...
        >
          <ProductCard :product="product" @click="goToDetail(product)" />
        </div>
      </div>

      <div
        v-else
        class="text-center py-20 bg-zinc-900/20 rounded-xl border border-dashed border-zinc-800"
      >
