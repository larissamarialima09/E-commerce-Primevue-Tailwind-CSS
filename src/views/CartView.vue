<template>
  <main class="p-6 bg-black min-h-screen flex flex-col items-center">
    <section
      class="cart-summary w-full max-w-4xl bg-zinc-900/40 p-6 rounded-2xl border border-zinc-800"
    >
      ...
      >
        <div
          class="w-24 h-24 bg-white rounded-lg flex-shrink-0 overflow-hidden shadow-lg shadow-emerald-500/10"
        >
          <img
      ...
      <div
        ...
        class="mt-10 pt-10 border-t-2 border-zinc-800 flex flex-col md:flex-row justify-between items-center gap-6"
      >
        <div class="text-center md:text-left">
          <p class="text-zinc-500 text-sm uppercase tracking-widest mb-1">
        ...
        <div class="text-right">
          ...
          <Button
            ...
            icon="pi pi-check"
            class="mt-4 bg-emerald-600 border-none w-full"
          />
        </div>
      </div>
    </section>
